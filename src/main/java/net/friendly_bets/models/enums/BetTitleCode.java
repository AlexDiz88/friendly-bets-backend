...
public enum BetTitleCode {
    ...
    // ⚠️ при изменении label/short-кода, нужно сделать миграцию данных для соответствия между enum и уже сохранёнными code/label в MongoDB.

    //========== 0. Пустая ставка / Удаленная пустая ставка (Empty Bet / Deleted Empty Bet) ==========
    EMPTY_BET_TITLE((short) 0, new GameResultChecker(), "EMPTY BET"),
