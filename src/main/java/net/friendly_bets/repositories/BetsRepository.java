...
public interface BetsRepository extends MongoRepository<Bet, String> {
    ...
    int countBySeason_IdAndLeague_IdAndMatchDayAndBetStatusNot(
            String seasonId,
            String leagueId,
            String matchDay,
            Bet.BetStatus betStatus
    ...
    List<Bet> findAllBySeason_IdAndLeague_IdAndMatchDayAndHomeTeam_IdAndAwayTeam_IdAndBetStatusIn(
            String seasonId,
            String leagueId,
            String matchDay,
            String homeTeamId,
    ...
    List<Bet> findAllBySeason_IdAndLeague_IdAndMatchDayAndBetStatusIn(
            String seasonId,
            String leagueId,
            String matchDay,
            List<Bet.BetStatus> betStatuses
    ...
    List<Bet> findAllByMatchScheduleIdAndBetStatusIn(String matchScheduleId, List<Bet.BetStatus> betStatuses);
